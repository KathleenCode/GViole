  ...
  return (
    <>
      <div className="home">
        <div className="hom">
          <h2>
            Welcome to the education <br /> against gun violence app
          </h2>
          <h3>
            Where gun violence sublimes, people despite class <br /> would then
            feel safer in the environment
          </h3>
          <p>No need to fret!</p>
          <p>Relax, and go through the information on the app</p>
          <div className="buttons">
            <button>
              <Link to="/resources">Help</Link>
            </button>
            <button>
              <Link to="/call">Resources</Link>
            </button>
          </div>
          <svg
          className="one"
