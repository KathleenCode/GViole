...
export default function Info() {
  useEffect(() => {
    document.querySelector(".to").addEventListener("wheel", (e) => {
      e.preventDefault();
      both.scrollLeft += e.deltaY;
      both.style.scrollBehavior = "auto";
    });
    // return () => {
    //     document.querySelector(".to").removeEventListener("wheel");
    // }
  });

  useEffect(() => {
    document.querySelector(".bck").addEventListener("click", (e) => {
      document.querySelector(".to").scrollLeft -= 250;
      document.querySelector(".to").style.scrollBehavior = "smooth";
    });
    // return () => {
    //     document.querySelector(".bck").removeEventListener('click');
    // }
  });

  useEffect(() => {
    document.querySelector(".nxt").addEventListener("click", (e) => {
      document.querySelector(".to").scrollLeft += 250;
      document.querySelector(".to").style.scrollBehavior = "smooth";
    });
    // return () => {
    //     document.querySelector(".nxt").removeEventListener('click');
    // }
  });
  ...
  return (
    <>
      <div className="info">
        <div className="inf">
          <p>
            In making our environment a safe space, by shielding the human{" "}
            <br />
            resource from gun violence through wiping off ignorance about gun{" "}
            <br />
            related issues, everyone could benefit, victim or victor
          </p>
          ...
          <div className="all">
            ...
            <div className="to">
              <div className="group">
                <img src={g1} alt="help" />
                <img src={g2} alt="humanity" />
                <img src={g3} alt="do not discriminate" />
                <img src={g4} alt="support for victims" />
                <img src={g5} alt="steps to avoid danger" />
                <img src={g6} alt="gun safety" />
                <img src={g7} alt="community" />
                <img src={g8} alt="society" />
                <img src={g9} alt="public safety" />
                <img src={g10} alt="cando spirit" />
              </div>
            </div>
            <span className="nxt">
              <IoIosFastforward />
